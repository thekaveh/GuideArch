...
- Visual snapshot harnesses (manual / opt-in, not in CI): Python `langs/python/tests/visual/snapshot_all_tabs.py` (Playwright), TypeScript `langs/typescript/tests/visual/snapshot-all-tabs.mjs` (headless Chromium via Playwright), C# `langs/csharp/tools/screenshot-all-tabs/`.
- Conformance:
