...
def test_theme_exposes_an_active_chart_token_getter():
...
def test_option_builders_accept_theme_tokens():
...
def test_chart_b_uses_the_three_fuzzy_tokens():
...
def test_dark_only_background_literal_is_gone_from_builders():
